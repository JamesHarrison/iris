...
* rdimport available on job workers (only for Rivendell systems- basically, your job workers need to be configured Rivendell installs)
...
Myriad support has not yet been added- I'm waiting for P Squared to do something about the stability of their import interface, as currently it crashes systems far too often for it to be usable.

Direct tagged file output is not yet there either, but will be soon. This will let librarians do manual import of files, but won't pass all metadata across.
