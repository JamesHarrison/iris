h1. IRIS is defunct - please don't use it

If you've landed here, sorry to disappoint, but this repository hasn't been updated in close to a decade and is full of holes, was never particularly well-written code in the first place, and should not be considered for new systems.

The good news is that "there is a successor":https://github.com/InsanityRadio/Nerve/ which is better (and _also_ won a Student Radio Award!) so you can use that instead.
